            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                ...
                <div className="mx-auto sm:mx-0">
                    ...
                    <div className="py-3 text-center lg:text-start">
                        ...
                        Externalisation et gestion <br /> de la paie sur le logiciel SILAE <br /> <br /> Administration et gestion <br /> du personnel <br /><br /> Audit social et vérification des bulletins de salaires <br /><br /> Accompagnement et conseils <br /> en droit des affaires
                        </h1>
                    </div>
